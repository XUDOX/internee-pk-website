...
export const DesktopMenu = ({ navLinks, onNavClick, isLoggedIn }: Props) => {
  ...
  return (
    <div className="items-center hidden md:flex gap-x-8">
      ...
      {/* ✅ ADDED: Conditional Intern Portal Link */}
      {isLoggedIn && (
        <button
          onClick={() => onNavClick("/intern-portal")}
          className="text-blue-600 text-sm font-semibold leading-5 hover:text-blue-700 transition-colors duration-200 flex items-center gap-x-1.5 relative group bg-transparent border-0 cursor-pointer p-0"
        >
