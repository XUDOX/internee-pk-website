export type InternshipCardProps = {
  ...
  description: string;
  href: string;
  onApply: () => void; // Add this new prop
};
      ...
      <div className="flex flex-col grow p-5">
        ...
        <div className="gap-x-2 flex gap-y-2">
          ...
          <button
            ...
            className="text-white text-sm font-medium items-center bg-lime-600 gap-x-1.5 flex basis-[0%] grow justify-center leading-5 py-2.5 rounded-full hover:bg-lime-700 active:scale-95 transition-all duration-200 cursor-pointer border-none"
          >
            Apply Now
